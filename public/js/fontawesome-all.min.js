...
!function() {
    ...
    "layers",
    "layers-text",
    "layers-counter"].concat(a.map(function(c) {
        return c+"x"
    }
    ...
    (function() {
        !function c(l, h) {
            ...
            "function"==typeof s.hooks.addPack?s.hooks.addPack(l, v):s.styles[l]=r( {}
            , s.styles[l]|| {}
            , v), "fas"===l&&c("fa", h)
        }
        ("fab", f)
...
function() {
    ...
    "layers",
    "layers-text",
    "layers-counter"].concat(d.map(function(c) {
        return c+"x"
    }
    ...
    A=Object.keys(x),
    q=k( {
        familyPrefix: "fa", replacementClass: o, autoReplaceSvg: !0, autoAddCss: !0, autoA11y: !0, searchPseudoElements: !1, observeMutations: !0, keepOriginalSource: !0, measurePerformance: !1, showMissingIcons: !0
    }
    , x);
    ...
    function R(c) {
        if(c&&M) {
            ...
            l.innerHTML=c;
            for(var h=t.head.childNodes, v=null, z=h.length-1;
            z>-1;
            z--) {
                var e=h[z],
                a=(e.tagName||"").toUpperCase();
                ["STYLE",
                "LINK"].indexOf(a)>-1&&(v=e)
            }
